...
public class CustomerPasswordEdit {
	...
	public void createCustomerEdit() {
		...
		Parent root = FXMLLoader.load(getClass().getResource("/application/CustomerEdit.fxml"));
		...
		customerEditStage.getIcons().add(new Image("/application/Javavirus GUI images/Javavirus Logo.png"));
